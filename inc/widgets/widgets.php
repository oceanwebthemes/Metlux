...
class metlux_Contact_Widget extends WP_Widget {
    ...
    public function form( $instance ) {
        ...
        <div class="widget-input-wrapper">
            <div class="widget-label">
                <label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title:', 'metlux'); ?></label>
            </div>
        ...
        <div class="widget-input-wrapper">
            <div class="widget-label">
                <label for="<?php echo $this->get_field_id('address'); ?>"><?php _e('Address:', 'metlux'); ?></label>
            </div>
            <div class="widget-input">
        ...
        <div class="widget-input-wrapper">
            <div class="widget-label">
                <label for="<?php echo $this->get_field_id('phone'); ?>"><?php _e('Phone:', 'metlux'); ?></label>
            </div>
            <div class="widget-input">
        ...
        <div class="widget-input-wrapper">
            <div class="widget-label">
                <label for="<?php echo $this->get_field_id('email'); ?>"><?php _e('E-mail:', 'metlux'); ?></label>
            </div>
            <div class="widget-input">
         ...
         <div class="widget-input-wrapper">
            <div class="widget-label">
                <label for="<?php echo $this->get_field_id('facebook'); ?>"><?php _e('Facebook Link:', 'metlux'); ?></label>
            </div>
            <div class="widget-input">
        ...
        <div class="widget-input-wrapper">
            <div class="widget-label">
                <label for="<?php echo $this->get_field_id('twitter'); ?>"><?php _e('Twitter Link:', 'metlux'); ?></label>
            </div>
            <div class="widget-input">
         ...
         <div class="widget-input-wrapper">
            <div class="widget-label">
                <label for="<?php echo $this->get_field_id('google_plus'); ?>"><?php _e('Google Plus Link:', 'metlux'); ?></label>
            </div>
            <div class="widget-input">
         ...
         <div class="widget-input-wrapper">
            <div class="widget-label">
                <label for="<?php echo $this->get_field_id('instagram'); ?>"><?php _e('Instagram Link:', 'metlux'); ?></label>
            </div>
            <div class="widget-input">
         ...
         <div class="widget-input-wrapper">
            <div class="widget-label">
                <label for="<?php echo $this->get_field_id('linkedin'); ?>"><?php _e('Linkedin Link:', 'metlux'); ?></label>
            </div>
            <div class="widget-input">
        ...
        <div class="widget-input-wrapper">
            <div class="widget-label">
                <label for="<?php echo $this->get_field_id('ytube'); ?>"><?php _e('Youtube Link:', 'metlux'); ?></label>
            </div>
            <div class="widget-input">
        ...
        <div class="widget-input-wrapper">
            <div class="widget-label">
                <label for="<?php echo $this->get_field_id('skype'); ?>"><?php _e('Skype Link:', 'metlux'); ?></label>
            </div>
            <div class="widget-input">
    ...
    public function update( $new_instance, $old_instance ) {
        ...
        $instance['address'] = ( ! empty( $new_instance['address'] ) ) ? wp_kses( $new_instance['address'] ) : '';
        $instance['phone'] = ( ! empty( $new_instance['phone'] ) ) ? wp_kses( $new_instance['phone'] ) : '';
        $instance['email'] = ( ! empty( $new_instance['email'] ) ) ? wp_kses( $new_instance['email'] ) : '';
        ...
        $instance['ytube'] = ( ! empty( $new_instance['ytube'] ) ) ? esc_url( $new_instance['ytube'] ) : '';
