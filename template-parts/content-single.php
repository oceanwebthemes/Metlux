...
<?php if( has_tag() ): ?>
    <div class="tag-and-share">
      <h3 class="content-title"><?php _e('Tags','metlux'); ?></h3>
      <div class="row">
  ...
  <?php endif; ?>
    ...
    <h3 class="content-title"><?php _e('Related Posts','metlux');?></h3>
    <div class="row">
      ...
      <div class="col-md-4 col-sm-6 col-xs-12 post-grid">
        ...
        <div class="post-single">
         <?php if(has_post_thumbnail()){ ?>
          ...
          <div><a href="<?php the_permalink()?>" class="btn btn-theme" title=""><?php _e('keep reading','metlux');?></a></div>
        </div>
      </div>
    <?php endwhile;endif;
    $post = $orig_post;
